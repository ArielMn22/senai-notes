    ...
    <>
      ...
      <div className="page__mask">
        ...
        <div className="form__container">
          ...
          <label>
            Email Address
            <input value={email} onChange={e => setEmail(e.target.value)} type="text" placeholder="email@example.com" />
          </label>
          ...
          <p className="form__hint">Already have an account? <a href="/login">Sign In</a></p>
